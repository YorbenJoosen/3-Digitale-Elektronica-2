...
HD_PWD='C:/Users/yorbe/Documents/School/3_Basis_Digitale_Elektronica_2/Opdracht4/Bresenham/Bresenham.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bresenham.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bresenham.tcl -notrace
