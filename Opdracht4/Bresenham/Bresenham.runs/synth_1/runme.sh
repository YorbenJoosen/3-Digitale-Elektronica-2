...
HD_PWD='C:/Users/yorbe/Documents/School/3_Basis_Digitale_Elektronica_2/Opdracht4/Bresenham/Bresenham.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bresenham.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bresenham.tcl
