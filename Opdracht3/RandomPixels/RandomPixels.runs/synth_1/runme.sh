...
HD_PWD='C:/Users/yorbe/Documents/School/3_Basis_Digitale_Elektronica_2/Opdracht3/RandomPixels/RandomPixels.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAInterface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGAInterface.tcl
