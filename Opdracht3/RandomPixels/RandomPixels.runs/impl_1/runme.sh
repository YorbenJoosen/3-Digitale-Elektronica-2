...
HD_PWD='C:/Users/yorbe/Documents/School/3_Basis_Digitale_Elektronica_2/Opdracht3/RandomPixels/RandomPixels.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGAInterface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGAInterface.tcl -notrace
